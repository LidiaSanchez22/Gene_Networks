...
moduleLabelsLL = netLL$colors
moduleColorsLL = labels2colors(netLL$colors)
MEsLL = netLL$MEs;
geneTreeLL = netLL$dendrograms[[1]];
save(MEsLL, moduleLabelsLL, moduleColorsLL, geneTreeLL, 
     file = "MouseLL-networkConstruction-auto.RData")

moduleLabelsML = netML$colors
moduleColorsML = labels2colors(netML$colors)
MEsML = netML$MEs;
geneTreeML = netML$dendrograms[[1]];
save(MEsML, moduleLabelsML, moduleColorsML, geneTreeML, 
     file = "MouseML-networkConstruction-auto.RData")

moduleLabelsSL = netSL$colors
moduleColorsSL = labels2colors(netSL$colors)
MEsSL = netSL$MEs;
geneTreeSL = netSL$dendrograms[[1]];
save(MEsSL, moduleLabelsSL, moduleColorsSL, geneTreeSL, 
     file = "MouseSL-networkConstruction-auto.RData")